      ...
      <Layout title="FOSCH Research Group">
        <Container>
          ...
          <Typography>
            ...
            explore the role of the oxidative status in modulating
            cardiovascular disease.
          </Typography>
          <Typography>
            FOSCH is led by Dr. Silvia M. Arribas, Physiologist of the Faculty
            of Medicine and Dr. Maria A. Martin, Bromatologist of the Faculty of
            Sciences of the UAM.
          </Typography>
